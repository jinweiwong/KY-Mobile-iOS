...
//    @State private var showingForgotPasswordView: Bool = false
//
//    @State private var errorMessage: EmailAuthError?
//    @State private var showErrorMessage = false
//
//    var body: some View {
//        ZStack {
...
//                        .alert(isPresented: $showErrorMessage) {
//                            Alert(title: Text("Login Error"),
//                                  message: Text(errorMessage?.localizedDescription ?? "Unknown Error"),
//                                  dismissButton: .default(Text("OK")) {
//                                    if errorSignIn == .incorrectPassword {
//                                        newUser.password = ""
//                                    }
//                                    else {
//                                        newUser.email = ""
...
//        Group {
//            SignInView(Binding.constant(newUser()))
//        }
//    }
//}
